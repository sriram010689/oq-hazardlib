...
class HB2002ASRTestCase(unittest.TestCase):
    ...
    def test_get_median_mag(self):
        self.assertAlmostEqual(self.asr.get_median_mag(100), 5.98)
        self.assertAlmostEqual(self.asr.get_median_mag(200), 6.281029996)
        self.assertAlmostEqual(self.asr.get_median_mag(300), 6.457121255)
        self.assertAlmostEqual(self.asr.get_median_mag(537), 6.709974286)
        self.assertAlmostEqual(self.asr.get_median_mag(600), 6.774201667)
        self.assertAlmostEqual(self.asr.get_median_mag(700), 6.863464053)
...
class EL2003BASRTestCase(unittest.TestCase):
    ...
    def test_get_median_mag(self):
        self.assertAlmostEqual(self.asr.get_median_mag(100), 6.2)
        self.assertAlmostEqual(self.asr.get_median_mag(200), 6.501029996)
        self.assertAlmostEqual(self.asr.get_median_mag(300), 6.677121255)
        self.assertAlmostEqual(self.asr.get_median_mag(537), 6.929974286)
        self.assertAlmostEqual(self.asr.get_median_mag(600), 6.97815125)
        self.assertAlmostEqual(self.asr.get_median_mag(700), 7.04509804)
