...
"""
Module :mod:`oqhazardlib.site` defines :class:`Site`.
"""
import numpy
...
class Site(object):
    ...
    :param location:
        Instance of :class:`~oqhazardlib.geo.point.Point` representing
    ...
    def __eq__(self, other):
        """
        >>> import oqhazardlib
        >>> point1 = oqhazardlib.geo.point.Point(1, 2, 3)
        >>> point2 = oqhazardlib.geo.point.Point(1, 2, 3)
        ...
        >>> site1 == site4
        False
        >>> point3 = oqhazardlib.geo.point.Point(1, 2, 4)
    ...
    def __str__(self):
        """
        >>> import oqhazardlib
        >>> loc = oqhazardlib.geo.point.Point(1, 2, 3)
