...
"""
Module :mod:`oqhazardlib.const` defines various constants.
"""
...
class IMC(ConstantContainer):
    ...
    :mod:`intensity measure <oqhazardlib.imt>`.
    """
...
class StdDev(ConstantContainer):
    ...
    #: (see
    #: :meth:`oqhazardlib.gsim.base.GroundShakingIntensityModel.get_poes`).
    TOTAL = 'Total'
