...
"""
Module :mod:`oqhazardlib.geo.point` defines :class:`Point`.
"""
import numpy
...
class Point(object):
    ...
    def to_polygon(self, radius):
        ...
        # and create oqhazardlib.geo.polygon.Polygon object from it
    ...
    def closer_than(self, mesh, radius):
        ...
        :param mesh:
            :class:`oqhazardlib.geo.mesh.Mesh` instance.
        :param radius:
        ...
        :returns:
            ...
            :func:`~oqhazardlib.geo.geodetic.distance` is used to
