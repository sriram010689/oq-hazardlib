...
"""
Module :mod:`oqhazardlib.geo.polygon` defines :class:`Polygon`.
"""
import numpy
...
class Polygon(object):
    ...
    :param points:
        The list of :class:`~oqhazardlib.geo.point.Point` objects
    ...
    def _from_2d(cls, polygon2d, proj):
        ...
        :param proj:
            ...
            by
            :func:`~oqhazardlib.geo._utils.get_orthographic_projection`
    ...
    def discretize(self, mesh_spacing):
        ...
        :returns:
            An instance of :class:`~oqhazardlib.geo.mesh.Mesh` that
