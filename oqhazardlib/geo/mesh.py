...
"""
Module :mod:`oqhazardlib.geo.mesh` defines classes :class:`Mesh` and
...
class Mesh(object):
    ...
    def from_points_list(cls, points):
        ...
        :param point:
            List of :class:`~oqhazardlib.geo.point.Point` objects.
        :returns:
    ...
    def __iter__(self):
        """
        Generate :class:`~oqhazardlib.geo.point.Point` objects the mesh
        is composed of.
    ...
    def get_min_distance(self, mesh):
        ...
        Uses :func:`oqhazardlib.geo.geodetic.min_distance`.
        """
    ...
    def get_closest_points(self, mesh):
        ...
        and uses the same :func:`oqhazardlib.geo.geodetic.min_distance`
        internally.
        """
    ...
    def _geodetic_min_distance(self, mesh, indices):
        """
        Wrapper around :func:`oqhazardlib.geo.geodetic.min_distance`
    ...
    def get_distance_matrix(self):
        ...
        Uses :func:`oqhazardlib.geo.geodetic.geodetic_distance`.
        """
    ...
    def get_convex_hull(self):
        ...
        :returns:
            Instance of :class:`oqhazardlib.geo.polygon.Polygon` that
...
class RectangularMesh(Mesh):
    ...
    def from_points_list(cls, points):
        ...
        :param point:
            List of lists of :class:`~oqhazardlib.geo.point.Point`
            objects.
        """
    ...
    def get_middle_point(self):
        ...
        :returns:
            An instance of :class:`~oqhazardlib.geo.point.Point`.
