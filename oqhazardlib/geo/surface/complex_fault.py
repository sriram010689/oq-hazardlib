...
"""
Module :mod:`oqhazardlib.geo.surface.complex_fault` defines
...
class ComplexFaultSurface(BaseSurface):
    ...
    :param mesh:
        Instance of :class:`~oqhazardlib.geo.mesh.RectangularMesh`
    ...
    def get_dip(self):
        ...
        :meth:`oqhazardlib.geo.mesh.RectangularMesh.get_mean_inclination_and_azimuth`
    ...
    def from_fault_data(cls, edges, mesh_spacing):
        ...
        :param edges:
            ...
            as instances of :class:`oqhazardlib.geo.line.Line`. The
    ...
    def surface_projection_from_fault_data(cls, edges):
        ...
        :param edges:
            ...
            of :class:`oqhazardlib.geo.line.Line`.
        :returns:
            Instance of :class:`~oqhazardlib.geo.polygon.Polygon`
    ...
    def get_width(self):
        ...
        See
        :meth:`oqhazardlib.geo.mesh.RectangularMesh.get_mean_width`
        """
