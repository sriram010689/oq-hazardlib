...
"""
Module :mod:`oqhazardlib.geo.surface.planar` contains
:class:`PlanarSurface`.
"""
import numpy
...
class PlanarSurface(BaseSurface):
    ...
    :class:`~oqhazardlib.geo.point.Point`) defining the surface
    ...
    See :class:`~oqhazardlib.geo.nodalplane.NodalPlane` for more
    ...
    def translate(self, p1, p2):
        ...
        :class:`oqhazardlib.geo.point.Point`) representing the
    ...
    def _create_mesh(self):
        """
        See
        :meth:`oqhazardlib.geo.surface.base.BaseSurface._create_mesh`.
        """
    ...
    def get_min_distance(self, mesh):
        ...
        <oqhazardlib.geo.surface.base.BaseSurface.get_min_distance>`.
    ...
    def get_closest_points(self, mesh):
        """
        See :meth:`superclass' method
        <oqhazardlib.geo.surface.base.BaseSurface.get_closest_points>`.
    ...
    def _get_top_edge_centroid(self):
        ...
        <oqhazardlib.geo.surface.base.BaseSurface._get_top_edge_centroid>`
    ...
    def get_top_edge_depth(self):
        """
        Overrides :meth:`superclass' method
        <oqhazardlib.geo.surface.base.BaseSurface.get_top_edge_depth>`
        in order to avoid creating a mesh.
        """
    ...
    def get_joyner_boore_distance(self, mesh):
        """
        See :meth:`superclass' method
        <oqhazardlib.geo.surface.base.BaseSurface.get_joyner_boore_distance>`.
