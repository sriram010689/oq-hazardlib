...
"""
Module :mod:`oqhazardlib.geo.surface.base` implements
:class:`BaseSurface`.
"""
import abc
...
class BaseSurface(object):
    ...
    def get_min_distance(self, mesh):
        ...
        :param mesh:
            :class:`~oqhazardlib.geo.mesh.Mesh` of points to calculate
            minimum distance to.
        :returns:
            A numpy array of distances in km.

        Base class implementation calls the :meth:`corresponding
        <oqhazardlib.geo.mesh.Mesh.get_min_distance>` method of the
    ...
    def get_closest_points(self, mesh):
        ...
        :param mesh:
            :class:`~oqhazardlib.geo.mesh.Mesh` of points to find
            closest points to.
        :returns:
            :class:`~oqhazardlib.geo.mesh.Mesh` of the same shape as
            ``mesh`` with closest surface's points on respective indices.

        Base class implementation calls the :meth:`corresponding
        <oqhazardlib.geo.mesh.Mesh.get_closest_points>` method of the
        surface's :meth:`mesh <get_mesh>`.
        """
    ...
    def get_joyner_boore_distance(self, mesh):
        ...
        :meth:`~oqhazardlib.geo.mesh.Mesh.get_joyner_boore_distance`.
        """
    ...
    def get_rx_distance(self, mesh):
        ...
        Base class calls
        :func:`oqhazardlib.geo.geodetic.distance_to_arc`.
    ...
    def _get_top_edge_centroid(self):
        """
        Return :class:`~oqhazardlib.geo.point.Point` representing the
    ...
    def _create_mesh(self):
        ...
        :returns:
            An instance of
            :class:`oqhazardlib.geo.mesh.RectangularMesh`.
        """
