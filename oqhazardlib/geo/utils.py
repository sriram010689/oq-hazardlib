...
"""
Module :mod:`oqhazardlib.geo.utils` contains functions that are common
...
from oqhazardlib.geo.geodetic import EARTH_RADIUS


def clean_points(points):
    """
    Given a list of :class:`~oqhazardlib.geo.point.Point` objects,
...
def get_orthographic_projection(west, east, north, south):
    ...
    (like in :meth:`oqhazardlib.geo.polygon.Polygon.discretize`). It
...
try:
    from oqhazardlib.geo import _utils_speedups
except ImportError:
