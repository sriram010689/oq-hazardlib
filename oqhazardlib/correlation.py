...
"""
Module :mod:`oqhazardlib.correlation` defines correlation models for
...
class BaseCorrelationModel(object):
    ...
    def get_lower_triangle_correlation_matrix(self, sites, imt):
        ...
        :param sites:
            :class:`~oqhazardlib.site.SiteCollection` to create
            correlation matrix for.
        :param imt:
            Intensity measure type object, see :mod:`oqhazardlib.imt`.
        """
    ...
    def apply_correlation(self, sites, imt, residuals):
        ...
        :param sites:
            :class:`~oqhazardlib.site.SiteCollection` residuals were
            sampled for.
        :param imt:
            Intensity measure type object, see :mod:`oqhazardlib.imt`.
        :param residuals:
