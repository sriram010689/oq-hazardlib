...
"""
Module :mod:`oqhazardlib.source.rupture` defines classes
...
class Rupture(object):
    ...
    :param rake:
        ...
        See :class:`~oqhazardlib.geo.nodalplane.NodalPlane`.
    :param tectonic_region_type:
        Rupture's tectonic regime. One of constants
        in :class:`oqhazardlib.const.TRT`.
    :param hypocenter:
        A :class:`~oqhazardlib.geo.point.Point`, rupture's hypocenter.
    :param surface:
        An instance of subclass of
        :class:`~oqhazardlib.geo.surface.base.BaseSurface`.
        Object representing the rupture surface geometry.
    :param source_typology:
        Subclass of :class:`~oqhazardlib.source.base.SeismicSource`
...
class ProbabilisticRupture(Rupture):
    ...
    :param temporal_occurrence_model:
        ...
        be an instance of :class:`oqhazardlib.tom.PoissonTOM`.
    ...
    def get_probability_one_or_more_occurrences(self):
        ...
        Uses
        :meth:`~oqhazardlib.tom.PoissonTOM.get_probability_one_or_more_occurrences`
    ...
    def get_probability_one_occurrence(self):
        ...
        Uses :meth:
        `~oqhazardlib.tom.PoissonTOM.get_probability_one_occurrence`
        of an assigned temporal occurrence model.
        """
        tom = self.temporal_occurrence_model
        rate = self.occurrence_rate
    ...
    def sample_number_of_occurrences(self):
        ...
        Uses :meth:
        `~oqhazardlib.tom.PoissonTOM.sample_number_of_occurrences`
        of an assigned temporal occurrence model.
        """
