...
"""
Module :mod:`oqhazardlib.source.area` defines :class:`AreaSource`.
"""
...
class AreaSource(PointSource):
    ...
    :param polygon:
        An instance of :class:`oqhazardlib.geo.polygon.Polygon`
    ...
    :class:`~oqhazardlib.source.point.PointSource`.
    """
    ...
    def get_rupture_enclosing_polygon(self, dilation=0):
        ...
        :meth:`~oqhazardlib.source.point.PointSource._get_max_rupture_projection_radius`.
    ...
    def iter_ruptures(self, temporal_occurrence_model):
        """
        See :meth:`oqhazardlib.source.base.SeismicSource.iter_ruptures`
        for description of parameters and return value.

        Area sources are treated as a collection of point sources
        (see :mod:`oqhazardlib.source.point`) with uniform parameters.
        ...
        `~oqhazardlib.geo.polygon.Polygon.discretize`
    ...
    def filter_sites_by_distance_to_source(self, integration_distance, sites):
        ...
        <oqhazardlib.source.point.PointSource.filter_sites_by_distance_to_source>`
