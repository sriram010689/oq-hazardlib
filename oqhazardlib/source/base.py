...
"""
Module :mod:`oqhazardlib.source.base` defines a base class for
seismic sources.
"""
import abc
...
class SeismicSource(object):
    ...
    :param tectonic_region_type:
        Source's tectonic regime. See :class:`oqhazardlib.const.TRT`.
    :param mfd:
        Magnitude-Frequency distribution for the source.
        See :mod:`oqhazardlib.mfd`.
    ...
    :param magnitude_scaling_relationship:
        ...
        :class:`oqhazardlib.scalerel.base.BaseMSR` to
    ...
    def iter_ruptures(self, temporal_occurrence_model):
        ...
        :param temporal_occurrence_model:
            ...
            :class:`oqhazardlib.tom.PoissonTOM`). It is passed intact
            to the probabilistic rupture constructor.
        :returns:
            Generator of instances of :class:
            `~oqhazardlib.source.rupture.ProbabilisticRupture`.
        """
    ...
    def filter_sites_by_distance_to_source(self, integration_distance, sites):
        ...
        :param sites:
            ...
            to filter.
        :returns:
            Filtered :class:`~oqhazardlib.site.SiteCollection`.
        ...
        :meth:
        `containment <oqhazardlib.geo.polygon.Polygon.intersects>`
        of site locations.
    ...
    def filter_sites_by_distance_to_rupture(cls, rupture, integration_distance,
        ...
        :param rupture:
            Instance of :class:`~oqhazardlib.source.rupture.Rupture`
            ...
            :meth:`~oqhazardlib.source.point.PointSource.filter_sites_by_distance_to_rupture`.
    ...
    def get_annual_occurrence_rates(self, min_rate=0):
        ...
        (see :meth:`oqhazardlib.mfd.base.BaseMFD.get_annual_occurrence_rates`)
