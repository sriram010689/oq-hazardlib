...
"""
Module :mod:`oqhazardlib.source.complex_fault`
...
class ComplexFaultSource(SeismicSource):
    ...
    :param edges:
        A list of :class:`~oqhazardlib.geo.line.Line` objects,
        representing fault source geometry. See
        :meth:`oqhazardlib.geo.surface.complex_fault.ComplexFaultSurface.from_fault_data`.
    :param rake:
    ...
    :raises ValueError:
        If :meth:`~oqhazardlib.geo.surface.complex_fault.ComplexFaultSurface.check_fault_data`
    ...
    def get_rupture_enclosing_polygon(self, dilation=0):
        """
        Uses :meth:`oqhazardlib.geo.surface.complex_fault.ComplexFaultSurface.surface_projection_from_fault_data`
        for getting the fault's surface projection and then calls
        its :meth:`~oqhazardlib.geo.polygon.Polygon.dilate`
