...
"""
Module :mod:`oqhazardlib.source.simple_fault` defines
...
class SimpleFaultSource(SeismicSource):
    ...
    :param fault_trace:
        A :class:`~oqhazardlib.geo.line.Line` representing
    ...
    :raises ValueError:
        If :meth:`~oqhazardlib.geo.surface.simple_fault.SimpleFaultSurface.check_fault_data`
    ...
    def get_rupture_enclosing_polygon(self, dilation=0):
        """
        Uses :meth:`oqhazardlib.geo.surface.simple_fault.SimpleFaultSurface.surface_projection_from_fault_data`
