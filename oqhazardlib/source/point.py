...
"""
Module :mod:`oqhazardlib.source.point` defines :class:`PointSource`.
"""
import math
...
class PointSource(SeismicSource):
    ...
    See also :class:`oqhazardlib.source.base.SeismicSource`
    ...
    def get_rupture_enclosing_polygon(self, dilation=0):
        ...
        <oqhazardlib.source.base.SeismicSource.get_rupture_enclosing_polygon>`
    ...
    def filter_sites_by_distance_to_source(self, integration_distance, sites):
        ...
        <oqhazardlib.source.base.SeismicSource.filter_sites_by_distance_to_source>`
    ...
    def filter_sites_by_distance_to_rupture(cls, rupture, integration_distance,
        ...
        <oqhazardlib.source.base.SeismicSource.filter_sites_by_distance_to_rupture>`.
        """
    ...
    def iter_ruptures(self, temporal_occurrence_model):
        """
        See :meth:
        `oqhazardlib.source.base.SeismicSource.iter_ruptures`.
    ...
    def _iter_ruptures_at_location(self, temporal_occurrence_model, location,
        ...
        and :class:`~oqhazardlib.source.area.AreaSource`.

        :param temporal_occurrence_model:
            The same object as given to :meth:`iter_ruptures`.
        :param location:
            A :class:`~oqhazardlib.geo.point.Point`
    ...
    def _get_rupture_dimensions(self, mag, nodal_plane):
        ...
        :param nodal_plane:
            Instance of :class:`oqhazardlib.geo.nodalplane.NodalPlane`.
        :returns:
            Tuple of two items: rupture length in width in km.

        The rupture area is calculated using method
        :meth:`~oqhazardlib.scalerel.base.BaseMSR.get_median_area`
        of source's
    ...
    def _get_rupture_surface(self, mag, nodal_plane, hypocenter):
        ...
        :returns:
            Instance of :class:`~oqhazardlib.geo.surface.planar.PlanarSurface`.
        """
