...
from oqhazardlib.gsim.campbell_2003 import _compute_faulting_style_term
from oqhazardlib.gsim.base import CoeffsTable, GMPE
...
class ToroEtAl2002(GMPE):
    ...
    #:attr:`~oqhazardlib.const.IMC.AVERAGE_HORIZONTAL`,
