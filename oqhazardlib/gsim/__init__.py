...
"""
Package :mod:`oqhazardlib.gsim` contains base and specific
implementations of ground shaking intensity models. See
:mod:`oqhazardlib.gsim.base`.
"""
import os
import inspect
import importlib
from collections import OrderedDict
from oqhazardlib.gsim.base import GMPE, IPE, CoeffsTable
