...
"""
:mod:`oqhazardlib.calc.hazard_curve` implements
...
def hazard_curves_poissonian(
    ...
    :class:`Poissonian <oqhazardlib.tom.PoissonTOM>` temporal
    occurrence model.
    ...
    :param sources:
        ...
        of :class:`~oqhazardlib.source.base.SeismicSource`).
    :param sites:
        Instance of :class:`~oqhazardlib.site.SiteCollection` object,
        representing sites of interest.
    :param imts:
        Dictionary mapping intensity measure type objects (see
        :mod:`oqhazardlib.imt`) to lists of intensity measure levels.
    :param time_span:
        An investigation period for Poissonian temporal occurrence model,
        floating point number in years.
    :param gsims:
        Dictionary mapping tectonic region types (members
        of :class:`oqhazardlib.const.TRT`) to
        :class:`~oqhazardlib.gsim.base.GMPE` or
        :class:`~oqhazardlib.gsim.base.IPE` objects.
