...
"""
:mod:`oqhazardlib.calc.disagg` contains :func:`disaggregation` as well
...
from oqhazardlib.geo.utils import get_spherical_bounding_box
from oqhazardlib.geo.utils import get_longitudinal_extent
from oqhazardlib.geo.geodetic import npoints_between
...
def disaggregation(sources, site, imt, iml, gsims, tom,
    ...
    :param sources:
        ...
        :mod:`PSHA <oqhazardlib.calc.hazard_curve>` calculator it
        should be an iterator of seismic sources.
    :param site:
        :class:`~oqhazardlib.site.Site` of interest to calculate
        disaggregation matrix for.
    :param imt:
        Instance of :mod:`intensity measure type <oqhazardlib.imt>`
        class.
    :param iml:
    ...
    :param tom:
        ...
        such as :class:`~oqhazardlib.tom.PoissonTOM`. It is used for
