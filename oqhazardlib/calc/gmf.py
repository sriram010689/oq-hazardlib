...
"""
Module :mod:`~oqhazardlib.calc.gmf` exports
...
def ground_motion_fields(rupture, sites, imts, gsim, truncation_level,
    ...
    :param oqhazardlib.source.rupture.Rupture rupture:
        Rupture to calculate ground motion fields radiated from.
    :param oqhazardlib.site.SiteCollection sites:
    ...
    :param gsim:
        ...
        :class:`~oqhazardlib.gsim.base.IPE`.
    ...
    :param correlation_model:
        ...
        :mod:`oqhazardlib.correlation`. Can be ``None``, in which case
